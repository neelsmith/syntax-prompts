...
Next, for those tokens identified in the previous table of verbal units, copy in the "VUID" column the value of the "VUID" column in the table of verbal units.

Leave the columns "Link1", "Relation1", "Link2", "Relation2" empty.
